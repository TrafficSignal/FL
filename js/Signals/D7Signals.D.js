function loadHernandoCountySignals(){ 
	$.get("xml/HernandoCountySignal.xml", {}, function(data) {
		...
		//Icon Sytyle
			var image = 'images/HernandoCountySignal.png' ;
		...
		//Contents of Info Window
				var contentString = '<div id="signalinfowindow"><img src="images/HernandoCountySmallSeal.gif">' + 
...
function loadPlantSignals(){ 
	$.get("xml/PlantSignal.xml", {}, function(data) {
		$(data).find("marker").each(function() {
			var marker = $(this);
			var intname = $(this).attr('intname');
			var intnum = $(this).attr('intnum');
			var latlng = new google.maps.LatLng(parseFloat(marker.attr("lat")),parseFloat(marker.attr("lng")));
		//Icon Sytyle
			var image = 'images/PlantSignal.png' ;
			var marker = new google.maps.Marker({
				position: latlng, 
				map: map,
				icon: image
		...
		//Contents of Info Window
				var contentString = '<div id="signalinfowindow"><img src="images/PlantSmallSeal.gif">' + 
				'Intersection number: <b>' +intnum+ '</b><br>' +
				'Intersection name:<b>' +intname+ '</b><br>' +
				'<font size="1" color="purple">'+
				'</div>' ;
...
function loadStPetersburgSignals(){ 
	$.get("xml/StPetersburgSignal.xml", {}, function(data) {
		$(data).find("marker").each(function() {
			var marker = $(this);
			var intname = $(this).attr('intname');
			var intnum = $(this).attr('intnum');
			var latlng = new google.maps.LatLng(parseFloat(marker.attr("lat")),parseFloat(marker.attr("lng")));
		//Icon Sytyle
			var image = 'images/StPetersburgSignal.png' ;
			var marker = new google.maps.Marker({
				position: latlng, 
				map: map,
				icon: image
		...
		//Contents of Info Window
				var contentString = '<div id="signalinfowindow"><img src="images/StPetersburgSmallSeal.gif">' + 
				'Intersection number: <b>' +intnum+ '</b><br>' +
				'Intersection name:<b>' +intname+ '</b><br>' +
				'<font size="1" color="purple">'+
				'</div>' ;
